...
import {TaskH, TaskD,TaskC,TaskM,TaskE, TaskF, TaskFinal, 
      ...
      return (
        <div className="round">
          <div className="content">
            ...
            {stage.name === "start" && <TaskF game={game} round={round} stage={stage} player={player} />}
            {stage.name === "end" && <TaskFinal game={game} round={round} stage={stage} player={player} />}
